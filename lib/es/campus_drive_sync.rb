...
module ES
	class CampusDriveSync < ElasticsearchConfiguration
		...
		def create_campus_drive_hash(drive_id)
			...
			hash = {:college=>row[0],:university=>row[1],:address=>row[2],:date_of_drive=>row[3],:no_of_students=>row[4],:department=>row[5],:hod_email=>row[6],:coordinator_email_1=>row[7],:coordinator_email_2=>row[8],:coordinator_phone_1=>row[9],:coordinator_phone_2=>row[10],:description=>row[11]}
			return hash
		end
